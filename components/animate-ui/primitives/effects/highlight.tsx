...
/** biome-ignore-all lint/complexity/noExcessiveCognitiveComplexity: <shadcn code> */
/** biome-ignore-all lint/suspicious/noArrayIndexKey: <shadcn code> */
/** biome-ignore-all lint/style/noNestedTernary: <shadcn code> */
...
const HighlightContext = React.createContext<
  // biome-ignore lint/suspicious/noExplicitAny: <shadcn code>
